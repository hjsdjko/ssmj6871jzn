<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="领取编号" prop="lingqubianhao">
					<el-input v-model="ruleForm.lingqubianhao" placeholder="领取编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.lingqubianhao" label="领取编号" prop="lingqubianhao">
					<el-input v-model="ruleForm.lingqubianhao" placeholder="领取编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="领取时间" prop="lingqushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.lingqushijian" label="领取时间" prop="lingqushijian">
					<el-input v-model="ruleForm.lingqushijian" placeholder="领取时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="领取账号" prop="lingquzhanghao">
					<el-input v-model="ruleForm.lingquzhanghao" placeholder="领取账号" clearable  :readonly="ro.lingquzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="领取账号" prop="lingquzhanghao">
					<el-input v-model="ruleForm.lingquzhanghao" placeholder="领取账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="领取姓名" prop="lingquxingming">
					<el-input v-model="ruleForm.lingquxingming" placeholder="领取姓名" clearable  :readonly="ro.lingquxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="领取姓名" prop="lingquxingming">
					<el-input v-model="ruleForm.lingquxingming" placeholder="领取姓名" readonly></el-input>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `juanzenglingqu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.juanzenglingquCrossAddOrUpdateFlag = false;
											this.parent.search();
